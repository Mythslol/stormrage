...
//Custom table
	static ChatCommand vipAuctionCommandTable[] =
	{                                                                                                 
		{ "alliance",       SEC_VIP,           false, &ChatHandler::HandleVipAuctionAllianceCommand,  "", nullptr },
		{ "goblin",         SEC_VIP,           false, &ChatHandler::HandleVipAuctionGoblinCommand,    "", nullptr },
		{ "horde",          SEC_VIP,           false, &ChatHandler::HandleVipAuctionHordeCommand,     "", nullptr },
		{ "",               SEC_VIP,  		   false, &ChatHandler::HandleVipAuctionCommand,          "", nullptr },
		{ nullptr,          0,                 false, nullptr,                                        "", nullptr }
	};
	static ChatCommand vipCommandTable[] =
	{
		{ "auction",        SEC_VIP,           false, nullptr,                                        "", vipAuctionCommandTable },
		{ "repair",         SEC_VIP,     	   false, &ChatHandler::HandleVipRepairitemsCommand,      "", nullptr },
        { "buffs",          SEC_VIP,  		   false, &ChatHandler::HandleBuffCommand,                                        "", nullptr },
        { "bank",           SEC_VIP,           false, &ChatHandler::HandleVipBankCommand,             "", nullptr },
        { nullptr,          0,                 false, nullptr,                                        "", nullptr }
	};
...
//custom
		{ "nannounce",      SEC_MODERATOR,      true, &ChatHandler::HandleCustomAnn,                  "", nullptr },
