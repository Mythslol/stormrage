...
//custom
		bool HandleCustomAnn(char* args);
		bool HandleVipBankCommand(char* args);
		bool HandleVipRepairitemsCommand(char* args);
	    bool HandleVipAuctionAllianceCommand(char* args);
		bool HandleVipAuctionHordeCommand(char* args);
		bool HandleVipAuctionGoblinCommand(char* args);
